...
export function SEOHead({ 
  title, 
  description, 
  image = 'https://images.unsplash.com/photo-1517134191118-9d595e4c8c2b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=1080',
  type = 'website'
}: SEOHeadProps) {
  ...
  useEffect(() => {
    ...
    updateMetaTag('keywords', `full stack developer, ${photographerInfo.name}, React, Node.js, TypeScript, web development`);
